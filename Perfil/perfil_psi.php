...
<head>
    ...
    <link rel="stylesheet" href="perfil_psi.css">
        ...
        <section class="profile-section">
            ...
            <div class="profile-card">
                <div class="profile-info">
                    ...
                    <h2>Psicólogo: <span><?php echo $_SESSION['nombre'] ?></span></h2>
                    <div class="profile-actions">
                        <div class="columna1">
                            <a  class="eliminar" href="b_diagnos.html">Diagnósticos estudiantiles</a>
                            <button>Editar perfil</button>

                        </div>
                        <div class="columna1">
                            
                            <a class="eliminar2" href="/Formulario/index.html">Agenda de citas</a>
