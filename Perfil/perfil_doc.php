...
<head>
    ...
    <link rel="stylesheet" href="perfil_doc.css">
        ...
        <section class="profile-section">
            ...
            <div class="profile-card">
                <div class="profile-info">
                    ...
                    <h2>Docente: <span><?php echo $_SESSION['nombre'] ?></span></h2>
                    <div class="profile-actions">
                        <div class="columna1">
                            
                        <a  class="registro" href="editar_registro.php">Editar Perfil</a>
                            <button>Ir al blog</button>
                        </div>
                        <div class="columna1">
                            <a  class="eliminar" href="b_diagnos.html">Buscar diagnóstico estudiantil</a>
                        </div>
                    </div>
